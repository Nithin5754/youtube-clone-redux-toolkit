const videoCards = ({info}) => {
  ...
  return (
<div key={info.id} className="w-[400px] h-[300px] flex flex-col items-center justify-center m-4 overflow-hidden rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-500">
